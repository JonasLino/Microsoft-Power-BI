  ...
  return (
    <div className="min-h-screen font-sans text-gray-800">
      ...
      <header id="sobre" className="relative bg-[#f0ead6] text-gray-900 pt-24 w-full">
        <div className="container mx-auto px-4 py-24 flex flex-col md:flex-row items-center justify-between gap-8">
          {/* Texto */}
          <div className="md:w-1/2 space-y-6">
            ...
            <div className="flex gap-4 mt-4 flex-wrap">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold hover:bg-blue-600 transition-colors"
              >
                LinkedIn
              </a>
            </div>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="w-48 h-48 sm:w-56 sm:h-56 rounded-full overflow-hidden shadow-2xl border-4 border-[#ffffff]">
              <img
